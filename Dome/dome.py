...
#def version():
	#print("+------------------------------------------------------------------------+")
	#print("| Ce Progamme est utilisé dans le cadre de notre projet professionnel	|")
	#print("| Nous nous sommes basés sur cet outil utilisant des techniques d'OSINT	|")
	#print("|																		|")
	#print("|																		|")
	#print("|																		|")
	#print("|																		|")
	#print("| Auteur : Yaya Fofana													|")
	#print("| Auteur : Yaya Fofana													|")
	#print("+ -----------------------------------------------------------------------+")
	#print
